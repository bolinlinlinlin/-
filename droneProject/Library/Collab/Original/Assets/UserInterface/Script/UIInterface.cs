...
public class UIInterface : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //電池
        BatteryPowerCount = (int)(10 * droneMovementScript.BatteryPowerTimer);
        if(BatteryPowerCount % 140 == 0 && BatteryPowerCount != 0)
        {
            BatteryPower -= 1;
        ...
        fuck.transform.rotation = Quaternion.Euler(Vector3.forward* droneMovementScript.DroneAngle);
